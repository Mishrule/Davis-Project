...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "UPDATE tblaccounts SET studentNumber=:studentNumber, academicYear=:academicYear, term=:term, billamount=:billamount, studentClass=:studentClass WHERE id=:id";
                                                ...
                                                if ($query->rowCount() > 0) {
                                                    foreach ($results as $result) {  ?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" name="billAmount" class="form-control" id="billAmount" value="<?php echo htmlentities($result->billamount) ?>" required="required" autocomplete="off" readonly>
                                                            </div>
                                                        </div>
