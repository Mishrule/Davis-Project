...
if ( strlen( $_SESSION[ 'alogin' ] ) == '' )
    ...
    if ( isset( $_POST[ 'submit' ] ) )
 {
        ...
        $guardContact = $_POST[ 'guardianContact' ];

        $guardName = $_POST[ 'guardianName' ];

        $status = 1;
        $sql = 'INSERT INTO  tblstudents(StudentName,RollId,StudentEmail,Gender,ClassId,DOB,Status,guardianName,guardianContact) VALUES(:studentname,:roolid,:studentemail,:gender,:classid,:dob,:status,:guardianName,:guardianContact)';
        ...
        $query->bindParam( ':guardianName', $guardName, PDO::PARAM_STR );
        $query->bindParam( ':guardianContact', $guardContact, PDO::PARAM_STR );
        $query->execute();
                ...
                foreach ( $results as $result )
 {
                ...
                <div class = 'form-group'>
                <label for = 'default' class = 'col-sm-2 control-label'>Guardian
                Name</label>
                <div class = 'col-sm-10'>
                <input type = 'text' name = 'guardianName' class = 'form-control'
                id = 'guardianName' required = 'required' autocomplete = 'off'>
                </div>
                </div>
                <div class = 'form-group'>
                <label for = 'default' class = 'col-sm-2 control-label'>Guardian
                Contact</label>
                <div class = 'col-sm-10'>
                <input type = 'number' name = 'guardianContact' class = 'form-control'
                id = 'guardianContact' required = 'required' autocomplete = 'off'>
                </div>
                </div>
